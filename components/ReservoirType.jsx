...
const ReservoirType = ({ reservoirState: { state: { reservoirType, mFactor, }, stateSetter: { setReservoirType, setMFactor, }, }, }) => {
  ...
  return (
    <div className={`sticky mt-0 top-36 bg-gray-300 flex flex-row h-15 pb-1 justify-around w-full border-b-4 border-b-blue-900 self-start ${darkMode ? 'bg-gray-900 text-white' : ''}`}>
